...
?>
    ...
    <main class="container section center-content">
        <h1>Guía para decorar tu hogar</h1>

        <picture>
            <source srcset="build/img/outstanding2.webp" type="image/webp">
            <source srcset="build/img/outstanding2.jpg" type="image/jpeg">
            <img loading="lazy" src="build/img/outstanding2.jpg" alt="imagen destacada">
        </picture>
        
        <p class="text-entry">Escrito el: <span>20/10/2023</span> por: <span>Admin</span></p>
        ...
        <div class="property-summary">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem omnis fugiat sequi eveniet. Iste tempora praesentium impedit quasi dolor placeat nesciunt dolore eum, adipisci perferendis commodi, consectetur maiores vero corporis!</p>
        </div>
    </main>
