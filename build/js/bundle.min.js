function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNavigation)}function responsiveNavigation(){document.querySelector(".navigation").classList.toggle("show")}
