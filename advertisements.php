...
?>
    ...
    <main class="container section">
        ...
        <div class="container-advertisements">
            ...
            <div class="advertisement">
                <picture>
                    <source src="build/img/ad4.webp" type="image/webp">
                    <source src="build/img/ad4.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/ad4.jpg" alt="imagen anuncio">
                </picture>
            ...
            <div class="advertisement">
                <picture>
                    <source src="build/img/ad5.webp" type="image/webp">
                    <source src="build/img/ad5.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/ad5.jpg" alt="imagen anuncio">
                </picture>
            ...
            <div class="advertisement">
                <picture>
                    <source src="build/img/ad6.webp" type="image/webp">
                    <source src="build/img/ad6.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/ad6.jpg" alt="imagen anuncio">
                </picture>
